...
public class MessageTplCodeConstants {
	...
	/** 用户登录验证码模板(目前用于服务市场登录) */
	public static final String USER_LOGIN_VALIDATE_CODE_TPL = "userLoginValidateCodeTpl";

	/*****************************************双因子模块**********************************************/
	/** 双因子手机验证登录消息模板标识 */
	public static final String ELEMENT_MOBILE_VALID_CODE_TPL = "elementMobileValidCodeTpl";
	/** 双因子手机绑定消息模板标识 */
	public static final String ELEMENT_MOBILE_BIND_CODE_TPL = "elementMobileBindCodeTpl";
	/***********************************************************************************************/
