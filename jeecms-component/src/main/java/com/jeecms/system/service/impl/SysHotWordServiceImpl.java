...
public class SysHotWordServiceImpl extends BaseServiceImpl<SysHotWord, SysHotWordDao, Integer>
	...
	@Override
	public void saveBatch(HotWordDto dto, Integer siteId) throws GlobalException {
		String hotWord = dto.getHotWord();
		String[] words = StrUtils.splitAndTrim(hotWord, ",", "，");
		Set<String> set = new HashSet<String>(Arrays.asList(words));
		List<SysHotWord> list = new ArrayList<SysHotWord>();
		List<SysHotWord> updateList = new ArrayList<SysHotWord>();
		for (String str : set) {
