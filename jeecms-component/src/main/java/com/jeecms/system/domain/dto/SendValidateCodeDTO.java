...
public class SendValidateCodeDTO {
	...
	public String getSecondLevelName() throws GlobalException {
		...
		switch (this.getType()) {
			...
			case ValidateCodeConstants.CODE_TYPE_UPDATE_PAY_PASSWORD:
				...
				break;
				//双因子模块
			case CODE_TYPE_ELEMENT_MOBILE_VALID:
				levelName = ValidateCodeConstants.CODE_SECOND_LEVEL_IDENTITY_ELEMENT_VALID_PHONE;
				break;
			case CODE_TYPE_ELEMENT_MOBILE_BIND:
				levelName = ValidateCodeConstants.CODE_SECOND_LEVEL_IDENTITY_ELEMENT_BIND_PHONE;
				break;
	...
	public String getMessageTplCode() throws GlobalException {
		...
		switch (this.getType()) {
			...
			//双因子模块
			case CODE_TYPE_ELEMENT_MOBILE_VALID:
				result = MessageTplCodeConstants.ELEMENT_MOBILE_VALID_CODE_TPL;
				break;
			case CODE_TYPE_ELEMENT_MOBILE_BIND:
				result = MessageTplCodeConstants.ELEMENT_MOBILE_BIND_CODE_TPL;
				break;
			default:
				logger.info(java.text.Normalizer.normalize(
						String.format("type is mismatching -->%s", type),
