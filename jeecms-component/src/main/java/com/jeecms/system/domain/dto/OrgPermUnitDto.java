...
public class OrgPermUnitDto {
        ...
        /** 角色操作 */
        Set<MiniDataUnit> roleOps;

        /** 组织操作 */
        Set<MiniDataUnit> orgOps;
        ...
        public Set<MiniDataUnit> getRoleOps() {
                return roleOps;
        }

        public void setRoleOps(Set<MiniDataUnit> roleOps) {
                this.roleOps = roleOps;
        }

        public Set<MiniDataUnit> getOrgOps() {
                return orgOps;
        }

        public void setOrgOps(Set<MiniDataUnit> orgOps) {
                this.orgOps = orgOps;
        }
