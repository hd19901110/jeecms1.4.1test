...
public class HotWordDto {
         ...
         * 热词分类id
         */
        private Integer hotTermCategoryId;
        ...
        @NotNull
        public Integer getHotTermCategoryId() {
                return hotTermCategoryId;
        }

        public void setHotTermCategoryId(Integer hotWordCategoryId) {
                this.hotTermCategoryId = hotWordCategoryId;
        }
        ...
        public int hashCode() {
                ...
                result = prime * result + ((hotTermCategoryId == null) ? 0 : hotTermCategoryId.hashCode());
        ...
        public boolean equals(Object obj) {
                ...
                if (hotTermCategoryId == null) {
                        if (other.hotTermCategoryId != null) {
                                return false;
                        }
                } else if (!hotTermCategoryId.equals(other.hotTermCategoryId)) {
                        return false;
                }
                if (id == null) {
                        if (other.id != null) {
