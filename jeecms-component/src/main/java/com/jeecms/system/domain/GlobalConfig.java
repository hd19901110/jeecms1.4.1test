...
public class GlobalConfig extends AbstractDomain<Integer> implements ISysConfig, Serializable {
        ...
        public Map<String, String> getAttrs() {
                if(!attrs.containsKey(GlobalConfigAttr.CREDENTIAL_DIGEST_SM)){
                        attrs.put(GlobalConfigAttr.CREDENTIAL_DIGEST_SM,GlobalConfigAttr.FALSE_STRING);
                }
                return attrs;
        }
        ...
        public boolean getMemberRegisterExamine() {
                GlobalConfigAttr config = getConfigAttr();
                return config.getMemberRegisterExamine();
        }
        ...
        public Boolean getIsCredentialDigestSm() {
                GlobalConfigAttr config = getConfigAttr();
                return config.getIsCredentialDigestSm();
        }
