...
public class ValidateCodeConstants {
	...
	/********************************双因子模块******************************************/
	/** 双因子手机验证登录类型 */
	public static final int CODE_TYPE_ELEMENT_MOBILE_VALID = 98;
	/** 双因子手机绑定类型 */
	public static final int CODE_TYPE_ELEMENT_MOBILE_BIND = 99;
	/**********************************************************************************/
	...
	/*****************双因子模块***********************/
	/** 用户验证 */
	public static final String CODE_SECOND_LEVEL_IDENTITY_ELEMENT_VALID_PHONE = "elementValid_";
	/** 用户绑定 */
	public static final String CODE_SECOND_LEVEL_IDENTITY_ELEMENT_BIND_PHONE = "elementBind_";
