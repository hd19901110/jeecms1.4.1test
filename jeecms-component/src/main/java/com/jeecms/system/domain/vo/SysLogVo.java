...
public class SysLogVo {
	 ...
	 * 创建时间
	 */
	@Excel(name = "createTime", isImportField = "true_st")
	 ...
	 * 修改时间
	 */
	@Excel(name = "updateTime", isImportField = "true_st")
	private String updateTime;
	/**
	 * 修改人
	 */
	@Excel(name = "updateUser")
	...
	public SysLogVo(SysLog log) {
		...
		this.createTime = MyDateUtils.formatDate(log.getCreateTime(), MyDateUtils.COM_Y_M_D_H_M_S_PATTERN);
		this.createUser = log.getCreateUser();
		if (log.getUpdateTime() != null) {
			this.updateTime = MyDateUtils.formatDate(log.getUpdateTime(), MyDateUtils.COM_Y_M_D_H_M_S_PATTERN);
		}
