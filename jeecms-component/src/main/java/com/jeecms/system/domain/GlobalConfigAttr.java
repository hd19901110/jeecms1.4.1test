...
public class GlobalConfigAttr implements Serializable {
     ...
     * 加密方式是否采用国密SM3
     **/
    public static final String CREDENTIAL_DIGEST_SM = "isCredentialDigestSm";
    /**
     * 加密方式更改后的初始用户密码
     **/
    public static final String DIGEST_CHANGE_USER_INIT_PASSWD = "initPasswd";

    /**最后开启账户安全的时间*/
    public static final String LAST_OPEN_ACCOUNT_SECURITY_TIME = "lastOpenAccountSecurityTime";


    /**
     * 是否开启双因素认证
     **/
    public static final String ELEMENT_OPEN = "elementOpen";

    /**
     * 短信验证码长度
     **/
    public static final String ELEMENT_LENGTH = "elementLength";

    /**
     * 验证码有效期
     **/
    public static final String ELEMENT_VALID = "elementValid";
     ...
     * @return
     */
    public Boolean getIsCredentialDigestSm() {
        String str = getAttr().get(CREDENTIAL_DIGEST_SM);
        if (StringUtils.isBlank(str)) {
            return false;
        }
        return TRUE_STRING.equals(str);
    ...
    public void setIsCredentialDigestSm(String isIntranetSet) {
        getAttr().put(CREDENTIAL_DIGEST_SM, isIntranetSet);
    }
    ...
    public String getInitPasswd() {
        String str = getAttr().get(DIGEST_CHANGE_USER_INIT_PASSWD);
        return str;
    }

    public void setInitPasswd(String initPasswd) {
        getAttr().put(DIGEST_CHANGE_USER_INIT_PASSWD, initPasswd);
    }
    ...
    public String getAutoLogout() {
        return getAttr().get(AUTO_LOGOUT);
    }
    ...
    public Boolean getLoginMuti() {
        ...
        if (StringUtils.isNoneBlank(str)) {
            return !FALSE_STRING.equals(str.toLowerCase());
        }
        return true;
    }
    ...
    public boolean getAccountLockAuto() {
        ...
        if (StringUtils.isNoneBlank(str)) {
            return TRUE_STRING.equals(str.toLowerCase());
        }
        return false;
    }
    ...
    public Date getLastOpenAccountSecurityTime() {
        String str = getAttr().get(LAST_OPEN_ACCOUNT_SECURITY_TIME);
        if (StringUtils.isNoneBlank(str)) {
            return MyDateUtils.parseDate(str);
        }
        return null;
    ...
    public void setLastOpenAccountSecurityTime(Date date) {
        getAttr().put(LAST_OPEN_ACCOUNT_SECURITY_TIME, MyDateUtils.formatDate(date,MyDateUtils.COM_Y_M_D_H_M_S_PATTERN));
    }

    public String getFrontImgId() {
        return getAttr().get(FRONT_IMG_ID);
    }
    ...
    public String getOperIdentityImgId() {
        return getAttr().get(OPER_IDENTITY_IMG_ID);
    }
    ...
    public String getWechatPublicNumberImgId() {
        return getAttr().get(WECHAT_PUBLIC_NUMBER_IMG_ID);
    }
    ...
    public String getWechatSmallImgId() {
        return getAttr().get(WECHAT_SMALL_IMG_ID);
    }
    ...
    public String getIsActivationImage() {
        return getAttr().get(IS_ACTIVATION_IMAGE);
    }
    ...
    public String getIsSensitiveWords() {
        return getAttr().get(IS_SENSITIVE_WORDS);
    }
    ...
    public String getSensitiveWordsReplace() {
        return getAttr().get(SENSITIVE_WORDS_REPLACE);
    }
    ...
    public String getSystemFlagResourceId() {
        return getAttr().get(SYSTEM_FLAG_RESOURCE_ID);
    }
    ...
    public String getSystemFlagResourceUrl() {
        return getAttr().get(SYSTEM_FLAG_RESOURCE_URL);
    }
    ...
    public String getBaiduVoiceAppkey() {
        return getAttr().get(BAIDU_VOICE_APPKEY);
    }
    ...
    public String getBaiduVoiceSecret() {
        return getAttr().get(BAIDU_VOICE_SECRET);
    }
    ...
    public String getSsoLoginAppId() {
        return getAttr().get(SSO_LOGIN_APPID);
    }
    ...
    public String getSsoLoginAppSecret() {
        return getAttr().get(SSO_LOGIN_APPSECRET);
    }

    /**
     * 是否开启双因素
     **/
    public boolean getElementOpen() {
        String str = getAttr().get(ELEMENT_OPEN);
        if (StringUtils.isNotBlank(str)) {
            return (TRUE_STRING).equals(str);
        }
        return false;
    ...
    /**
     * 短信验证码长度 1.4位 2.6位 3.8位
     **/
    public String getElementLength() {
        return StringUtils.isNotBlank(getAttr().get(ELEMENT_LENGTH)) ? getAttr().get(ELEMENT_LENGTH) : "";
    }

    /**
     * 验证码有效期
     **/
    public String getElementValid() {
        return StringUtils.isNotBlank(getAttr().get(ELEMENT_VALID)) ? getAttr().get(ELEMENT_VALID) : "";
    }
