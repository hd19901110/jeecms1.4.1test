...
public class MessageTplDetailsDaoImpl extends BaseDao<MessageTplDetails> implements MessageTplDetailsExt {
    ...
    @Override
    public MessageTplDetails findByMesCodeAndType(String mesCode, Short detailMesType,Integer siteId,
                                                  boolean hasDeleted) {
        ...
        if (siteId != null) {
            condition = condition.and(messageTplDetails.siteId.eq(siteId));
        }
