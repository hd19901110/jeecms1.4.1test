...
//            ContentButtonConstant.OPERATE_RECORDING, ContentConstant.STATUS_PIGEONHOLE, ContentButtonConstant.OPERATE_OUTOFFILE);
    public static List<Integer> MORE = Arrays.asList(ContentButtonConstant.OPERATE_STICKY, ContentButtonConstant.OPERATE_NOT_STICKY,
            ContentButtonConstant.OPERATE_COPY, ContentButtonConstant.OPERATE_QUOTE, ContentButtonConstant.OPERATE_NOT_QUOTE,
            ContentButtonConstant.OPERATE_SORT, ContentButtonConstant.OPERATE_RELATED_CONTENT, ContentButtonConstant.OPERATE_VERSION,
            ContentButtonConstant.OPERATE_RECORDING, ContentConstant.STATUS_PIGEONHOLE);
    ...
    public static final Map<Integer, String> BUTTON_ICON = ImmutableMap.<Integer, String>builder().put(ContentConstant.STATUS_FIRST_DRAFT, "baocun")
            ...
            .put(ContentConstant.STATUS_PIGEONHOLE, "guidang").put(ContentButtonConstant.OPERATE_OUTOFFILE, "chudang").build();
    ...
    public static final Map<Integer, String> BUTTON_TEXT = ImmutableMap.<Integer, String>builder().put(ContentConstant.STATUS_FIRST_DRAFT, "存为初稿")
            ...
            .put(ContentConstant.STATUS_PIGEONHOLE, "归档").put(ContentButtonConstant.OPERATE_OUTOFFILE, "出档").build();
    ...
    public interface Api {
        ...
        Map<Integer,Map<String,String>> CONTENT_UPDATE_STATUS = ImmutableMap.<Integer, Map<String,String>>builder()
                .put(ContentButtonConstant.OPERATE_RECALL,ImmutableMap.of("/cmsadmin/task/revoke","GET"))
                .put(ContentConstant.STATUS_FLOWABLE,ImmutableMap.of("/cmsadmin/content/submit","POST"))
                .put(ContentConstant.STATUS_NOSHOWING,ImmutableMap.of("/cmsadmin/contentext/status","POST"))
                .put(ContentButtonConstant.OPERATE_PUSH_SITES,ImmutableMap.of("/cmsadmin/content/push/sites","PUT"))
                .put(ContentButtonConstant.OPERATE_PUSH_WECHAT,ImmutableMap.of("/cmsadmin/contentext/preview","POST"))
                .put(ContentButtonConstant.OPERATE_PUSH_WEIBO,ImmutableMap.of("/cmsadmin/weiboarticlepush","POST"))
                .put(ContentButtonConstant.OPERATE_STICKY,ImmutableMap.of("/cmsadmin/contentext/top","POST"))
                .put(ContentButtonConstant.OPERATE_NOT_STICKY,ImmutableMap.of("/cmsadmin/contentext/top","POST"))
                .put(ContentButtonConstant.OPERATE_QUOTE,ImmutableMap.of("/cmsadmin/contentext/quote","POST"))
                .put(ContentButtonConstant.OPERATE_NOT_QUOTE,ImmutableMap.of("/cmsadmin/contentext/quote","POST"))
                .put(ContentButtonConstant.OPERATE_SORT,ImmutableMap.of("/cmsadmin/contentext/sort","POST"))
                .put(ContentConstant.STATUS_PIGEONHOLE,ImmutableMap.of("/cmsadmin/contentext/status","POST"))
                .put(ContentButtonConstant.OPERATE_OUTOFFILE,ImmutableMap.of("/cmsadmin/contentext/file","POST"))
                .put(ContentButtonConstant.OPERATE_DELETE,ImmutableMap.of("/cmsadmin/contentext/rubbish","POST"))
                .build();
    ...
    public static final Map<Integer,String> FONT_END_NEED_KEY = ImmutableMap.<Integer,String>builder()
            ...
            .put(OPERATE_OUTOFFILE,"16").build();
    ...
    public enum OperatePiece{
        ...
        private static Map<OperatePiece,List<Integer>> pieces = new HashMap<OperatePiece,List<Integer>>();
        ...
        private static Map<Integer,List<OperatePiece>> statusOperatePiece = new HashMap<Integer,List<OperatePiece>>();

        private static Map<OperatePiece,String> pieceIcons = new HashMap<>();

        private static Map<OperatePiece,String> pieceTexts = new HashMap<OperatePiece,String>();
