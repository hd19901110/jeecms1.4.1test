...
public class QCmsModel extends EntityPathBase<CmsModel> {
    ...
    public final ListPath<com.jeecms.content.domain.Content, QContent> contents = this.<com.jeecms.content.domain.Content, QContent>createList("contents", com.jeecms.content.domain.Content.class, QContent.class, PathInits.DIRECT2);
