...
public interface ContentFrontService {
	 ...
	 * @return Page
	 */
	Page<Content> getPage(Integer channelOption,Integer[] channelIds, Integer[] tagIds, String[] channelPaths, Integer siteId,
	 ...
	 * @return 内容集合
	 */
	List<Content> getList(Integer channelOption,Integer[] channelIds, Integer[] tagIds, String[] channelPaths,
	...
	void updateContribute(ContentContributeDto dto, Channel channel, Content content,
                          HttpServletRequest request, ContentExt contentExt) throws GlobalException;
	 ...
	 * @return 详细投稿信息
	 */
	ContentContributeVo splicContributeVo(Integer contentId,Integer userId) throws GlobalException;
