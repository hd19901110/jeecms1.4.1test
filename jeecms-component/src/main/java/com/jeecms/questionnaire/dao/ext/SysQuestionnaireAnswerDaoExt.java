...
public interface SysQuestionnaireAnswerDaoExt {
	 ...
	 * @return Page
	 */
	List<SysQuestionnaireAnswer> find(List<String> uuids);
	 ...
	 * @return List
	 */
	List<SysQuestionnaireAnswer> findByReplayNameAndQuestionnaireId(String replayName, Integer questIntegerId, String uuid);
