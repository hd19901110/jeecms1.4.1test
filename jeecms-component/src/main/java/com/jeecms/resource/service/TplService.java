...
public interface TplService {
     ...
     * @return list
     */
    List<String> getIndexBySolutionPath(String solution, CmsSite site) throws IOException, GlobalException;
     ...
     * @return list
     */
    List<String> getIndexBySolutionPrefixPath(String solution, String prefix, CmsSite site)
