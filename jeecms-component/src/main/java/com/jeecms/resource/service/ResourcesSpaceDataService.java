...
public interface ResourcesSpaceDataService extends IBaseService<ResourcesSpaceData, Integer> {
	 ...
	 * @return Page
	 */
	Page<ResourcesSpaceData> getPage(Integer userId, String alias, String shareUser, Short resourceType, Integer storeResourcesSpaceId,
									 Integer uId, Pageable pageable);
