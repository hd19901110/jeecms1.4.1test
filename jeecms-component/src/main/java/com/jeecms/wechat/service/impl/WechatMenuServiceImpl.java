...
public class WechatMenuServiceImpl extends BaseServiceImpl<WechatMenu, WechatMenuDao, Integer>
	...
	public Integer deleteMenu(WechatMenuGroup menuGroup) throws GlobalException {
		if (menuGroup.getMenuGroupType().equals(WechatMenuServiceImpl.MENUGROUP_TYPE_INDIVIDUATION)
	...
	public WechatMenu saveMenu(WechatMenuGroup wGroup) throws GlobalException {
		...
		if (wGroup.getMenuGroupType().equals( WechatMenuServiceImpl.MENUGROUP_TYPE_INDIVIDUATION)
				&& wGroup.getStatus().equals(WechatMenuServiceImpl.MENUGROUP_STATUS_TRUE)) {
