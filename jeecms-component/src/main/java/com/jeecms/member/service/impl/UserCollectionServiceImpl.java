...
public class UserCollectionServiceImpl extends BaseServiceImpl<UserCollection, UserCollectionDao, Integer>
	...
	@Override
	public void save(UserCollection userCollection, Integer userId) throws GlobalException {
		Integer contentId = userCollection.getContentId();
		if (findByContentIdAndUserId(contentId, userId) == null) {
