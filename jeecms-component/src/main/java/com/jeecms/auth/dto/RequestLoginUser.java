...
public class RequestLoginUser {
         ...
         * 登录  用户验证码
         */
        public static final String LOGIN_CODE_MESSAGE = "codeMessage";
        /**
         * 用户名、邮箱、手机号
         */
        ...
        public static RequestLoginUser buildForMemberLogin(String identity, String pStr, RequestLoginTarget target,
                        String captcha, String uniquePushId, String codeMessage) {
                return new RequestLoginUser(identity, pStr, target, captcha, uniquePushId, codeMessage);
        }

        public RequestLoginUser(String identity, String pStr, RequestLoginTarget target, String captcha,
                        String uniquePushId, String codeMessage) {
                super();
