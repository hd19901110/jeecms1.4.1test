...
public class CoreUserAgent implements Serializable {
        ...
        private CoreUserAgent(Builder builder) {
                user = builder.user;
        }
        ...
        public static  void agentOwnerSites(CoreUser user) {
                CmsSiteService siteService = ApplicationContextProvider.getBean(CmsSiteService.class);
                siteService.findByIds(CmsSite.fetchIds(user.getOwnerSites()));
        }
        ...
        public static final class Builder {
                ...
                public Builder user(CoreUser val) {
                        user = val;
                        return this;
                }

                public CoreUserAgent build() {
                        return new CoreUserAgent(this);
                }
        }
}
