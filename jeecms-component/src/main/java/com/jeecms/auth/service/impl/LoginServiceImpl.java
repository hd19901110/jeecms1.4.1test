        ...
        if (loginDetail == null) {
            ...
            if (RequestLoginTarget.admin.equals(requestLoginUser.getTarget())) {
                ...
                if(config.getConfigAttr().getSecurityOpen()&&lastOpenAccountSecurityTime!=null&&user.getLastLoginTime()!=null){
                    ...
                    if(user.getLastLoginTime().before(MyDateUtils.getDayAfterTime(lastCompareTime,-config.getConfigAttr().getAccountLockAutoDay()))){
                        longTimeNoLogin = true;
                    }
                    if(longTimeNoLogin&&lastOpenAccountSecurityTime.after(MyDateUtils.getDayAfterTime(now,-config.getConfigAttr().getAccountLockAutoDay()))){
