...
public class MemberDispatcherConfig {
	...
	public ServletRegistrationBean<DispatcherServlet> memberDispatcherServletRegistration(
			ObjectProvider<MultipartConfigElement> multipartConfigProvider,DispatcherServlet memberDispatcherServlet) {
		ServletRegistrationBean<DispatcherServlet> registration = 
				new ServletRegistrationBean<DispatcherServlet>(memberDispatcherServlet, WebConstants.MEMBER_PREFIX + "/*");
		// 必须指定启动优先级，否则无法生效
