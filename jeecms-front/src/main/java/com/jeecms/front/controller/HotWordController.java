...
public class HotWordController {
	...
	@GetMapping("/list")
	@MoreSerializeField({@SerializeField(clazz = SysHotWord.class, includes = {"hotWord", "id",
	"cateName", "linkUrl", "isTargetBlank", "remark", "useCount", "clickCount"})})
	public ResponseInfo list(HttpServletRequest request) {
		...
		List<SysHotWord> list = hotWordService.getList(params, null, true);
