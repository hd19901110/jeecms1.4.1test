...
public class AliOssCloudClient {
	 ...
	 * @return: OSSClient
	 */
	public static List<String> parseList(String bucketName, String endpoint, String accessKeyId, String accessKeySecret,
										 String presix) {
		...
		if (!doesBucketExist(bucketName, endpoint, accessKeyId, accessKeySecret)) {
			...
			ObjectListing objectListing = ossClient.listObjects(bucketName,presix);
			for (OSSObjectSummary objectSummary : objectListing.getObjectSummaries()) {
				String name = objectSummary.getKey().replace(presix, "");
