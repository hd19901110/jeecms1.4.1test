...
public class HttpUtil {
    ...
    public static int getResponseCode(String url, Map<String, String> params) {
        return DELEGATE.getResponseCode(url,params);
    }
    ...
    public static void getIgnore(String url, Map<String, String> params) {
        DELEGATE.getIgnore(url, params);
    }
}
