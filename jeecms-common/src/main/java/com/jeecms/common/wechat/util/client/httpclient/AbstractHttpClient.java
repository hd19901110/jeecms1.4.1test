...
public abstract class AbstractHttpClient {
	...
	protected static final ResponseCodeHandler RESPONSE_CODE_HANDLER = new ResponseCodeHandler();
	 ...
	 * 构造Head请求.
	 */
	protected static HttpUriRequest buildHeadRequest(String url, Map<String, String> params) {
		return buildRequest(HttpHead.METHOD_NAME, url, params, null, null);
	}
	...
	private static class ResponseCodeHandler implements ResponseHandler<Integer> {
		@Override
