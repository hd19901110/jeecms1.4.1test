...
public enum SystemExceptionEnum implements ExceptionInfo {
	...
	/** 会员功能已关闭或会员注册功能关闭 */
	MEMBER_CLOSE_OR_REGISTERED_CLOSE("811", "member close or registered close!"),
    /** 操作已提交至三元管理*/
    OPERATION_HAS_BEEN_SUBMITTED_TO_TRINITY_MANAGEMENT("812","Operation has been submitted to Trinity Management!"),
    ;
    /** 异常代码。 */
	private String code;
