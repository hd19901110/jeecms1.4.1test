...
public enum UserErrorCodeEnum implements ExceptionInfo {
	...
	/** 父级组织不存在*/
	PARENT_ORG_NOT_EXIST("14046","Parent organizations do not exist"),
	/** 会员组不存在*/
	MEMBER_GROUP_NOT_EXIST("14047","Member group do not exist"),
	/** 会员等级不存在*/
	MEMBER_LEVEL_NOT_EXIST("14048","Member level do not exist"),
	/** 角色不存在*/
	ROLE_NOT_EXIST("14049","Role do not exist"),
	/** 组织不存在*/
	ORG_NOT_EXIST("14050","organizations do not exist"),
	;
