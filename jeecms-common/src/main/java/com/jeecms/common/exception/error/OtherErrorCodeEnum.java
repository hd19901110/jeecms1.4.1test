...
public enum OtherErrorCodeEnum implements ExceptionInfo {
    ...
    /** 数据备份服务不支持当前数据库 */
    BACK_DB_NO_SUPPORT_ERROR("14505", "数据备份服务不支持当前数据库!"),
    /** http请求超时*/
	HTTP_REQUEST_TIMEOUT("14506","Http request timeout!"),
    /** 服务市场未授权*/
    SERVICE_MARKET_NOT_AUTHORIZED("14507","Service market not authorized!"),
