...
public class CacheConstants {
	 ...
	 * 评论点赞缓存
	 */
	public static final String UP_CACHE = "upCache";
	...
	/**表单浏览量缓存*/
	public static final String SMART_FORM_VIEW_CACHE = "smartFormViewCache";
	/**站点检测缓存数据*/
	public static final String SITE_HEALTH_CACHE = "siteHealthCache";
}
