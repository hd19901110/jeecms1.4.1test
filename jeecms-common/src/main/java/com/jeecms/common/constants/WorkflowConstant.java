...
public abstract class WorkflowConstant {
	...
	public static final Map<Short,String> WORKFLOW_DATA_TYPE_MAP = ImmutableMap.of(WORKFLOW_DATA_TYPE_CONTENT,"内容",
            WORKFLOW_DATA_TYPE_QUESTIONNAIRE,"投票调查",WORKFLOW_DATA_TYPE_LETTER,"领导信箱");
