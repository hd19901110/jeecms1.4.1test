...
public class WechatInfoController extends BaseController<AbstractWeChatInfo, Integer> {
	...
	public ResponseInfo page(HttpServletRequest request, @RequestParam(value = "type") Short type,
		...
		List<AbstractWeChatInfo> infos = service.getList(user.getId(), siteId, type);
	 ...
	 * 显示服务器域名
	 */
	@RequestMapping(value = "/displayModifyDomain/{id:[0-9]+}", method = RequestMethod.GET)
	 ...
	 * 重置服务器域名
	 */
	@RequestMapping(value = "/modifyDomain/{id:[0-9]+}", method = RequestMethod.GET)
