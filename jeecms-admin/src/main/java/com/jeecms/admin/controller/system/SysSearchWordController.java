...
public class SysSearchWordController extends BaseAdminController<SysSearchWord, Integer> {
	...
	@SerializeField(clazz = SysSearchWord.class, includes = {"id", "word", "isRecommend", "searchCount", "sortNum","term"})
	...
	public ResponseInfo check(String term, Integer id, HttpServletRequest request) {
		return new ResponseInfo(service.checkWord(term, id, SystemContextUtils.getSiteId(request)));
	}
