...
public class SysHotWordCategoryController extends BaseAdminController<SysHotWordCategory, Integer> {
	 ...
	 */
	@DeleteMapping()
	public ResponseInfo delete(@RequestBody @Valid DeleteDto dels, HttpServletRequest request) throws GlobalException {
		service.deleteByIds(dels.getIds(), SystemContextUtils.getSiteId(request));
