...
//                        String msg = MessageResolver.getMessage(SystemExceptionEnum.OPERATION_HAS_BEEN_SUBMITTED_TO_TRINITY_MANAGEMENT.getCode(),
//                                SystemExceptionEnum.OPERATION_HAS_BEEN_SUBMITTED_TO_TRINITY_MANAGEMENT.getDefaultMessage());
//                        String code = SystemExceptionEnum.OPERATION_HAS_BEEN_SUBMITTED_TO_TRINITY_MANAGEMENT.getCode();
//                        ResponseInfo responseInfo = new ResponseInfo(code, msg);
//                        ResponseUtils.renderJson((HttpServletResponse) response, JSON.toJSONString(responseInfo));
